...
def create_new_PipelinePSD(list_of_lines, file_PSD_to_read):
    ...
    return changed_list_of_lines,test_script_lines
...
def compile_PSD_pipeline_working(file_name_complete_working, file_name_complete_test_work, list_filenames_PSD_to_read, dir_branch_complete,
...
def help_msg():
    ...
    help_str = """ Script to generate shadow PSD views for Data Pipeline
                    ...
                    Rewrite all PSD views by changing their name (putting_ final) all in the same file 07-mv_view-dpl_biz.sql
                   """
    return help_str
...
if __name__ == '__main__':
    ...
    compile_PSD_pipeline_working(file_name_complete_working,file_name_complete_test_work, list_filenames_PSD_to_read, dir_branch_complete,
                                 file_name_complete_target)
